...
Les territoires locaux se laissent rarement comprendre à partir d’un seul indicateur. Niveau de vie, fragilités sociales, dynamiques économiques, sécurité, environnement, structure urbaine ou périurbaine  ces dimensions interagissent, se renforcent parfois, se contredisent souvent, et deviennent difficiles à lire dès qu’elles sont observées séparément.

TerriZoom vise à croiser plusieurs sources de données publiques afin de construire une lecture territoriale plus structurée, comparative et exploitable à l’échelle communale. Le projet ne cherche donc pas à produire un simple tableau descriptif, mais un cadre d’analyse permettant de faire émerger des profils territoriaux, d’en discuter les limites, puis de tester une première logique d’aide à la décision multicritère.
...
Remarque  l’analyse TOPSIS  ELECTRE III ne mobilise qu’un sous-ensemble de cette base complète, sélectionné pour l’exercice de classement multicritère.
...
Les données présentent plusieurs défis 
 ...
 restriction finale à un sous-ensemble de communes disposant d’un recouvrement exploitable entre sources.
...
A titre d’exemple, le notebook d’exploration et d’agrégation est disponible [ici](httpsgithub.commurielleboens-dotdata-analytics-portfolio-murielle-boensblobmain03_projet-perso-TerriZoom-territorial-data-pyN4%20%E2%80%94%20EXPLORE%20%26%20AGGREGATE%20TerriZoom.ipynb).
...
L’approche repose sur une logique d’analyse multi-factorielle 
 ...
 analyse exploratoire des distributions, des couvertures et des contrastes ;
 test de méthodes multicritères complémentaires.

Une attention particulière est portée 

 aux biais liés aux données déclaratives ;
 aux différences de granularité ;
 aux effets de structure liés à la taille des communes ;
 aux limites d’interprétation des corrélations et des classements.
...
#### Résultats clés — page 1
 ...
 Les communes urbaines intermédiaires et urbaines denses présentent en moyenne les revenus médians les plus élevés du périmètre étudié.
 Les communes rurales, lorsqu’elles sont présentes dans le subset, se situent globalement à des niveaux de revenu plus faibles.
